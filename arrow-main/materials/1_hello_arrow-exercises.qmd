...
# #| eval: false
taxi_size <- tibble(
  files = list.files("/mnt/shared/data/nyc-taxi-tiny/", recursive = TRUE),
  size_GB = file.size(file.path("/mnt/shared/data/nyc-taxi-tiny/", files)) / 10**9
)
taxi_size
...
1.  Calculate the longest trip distance for every month in 2017

2.  How long did this query take to run?

## Solution 1

Longest trip distance for every month in 2017:
